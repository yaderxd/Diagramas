...
select NombreMun,NombreDpto from Deptos inner join
Municipios on Deptos.Id_Dptos=Municipios.Id_Dpto
...
select NombreProd,existp from Productos where existp<3
